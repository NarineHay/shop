...
!function(e, t) {
        ...
        function r(t, n) {
            if (t)
                if (t.resizedAttached)
                    ...
                    t.resizeSensor.innerHTML = '<div class="resize-sensor-expand" style="' + o + '"><div style="' + s + '"></div></div><div class="resize-sensor-shrink" style="' + o + '"><div style="' + s + ' width: 200%; height: 200%"></div></div>',
                    ...
                    var c, f, h = t.resizeSensor.childNodes[0], a = h.childNodes[0], l = t.resizeSensor.childNodes[1], u = i(t), v = u.width, p = u.height, z = !0, w = 0, g = function() {
                        if (z) {
                            if (0 === t.offsetWidth && 0 === t.offsetHeight)
                                return void (w || (w = e(function() {
                                    w = 0,
                                    g()
                                })));
                            z = !1
    ...
    n.detach = function(e, i) {
        t(e, function(e) {
            e && (e.resizedAttached && "function" == typeof i && (e.resizedAttached.remove(i),
