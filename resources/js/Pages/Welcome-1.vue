...
<template>
    ...
    <div class="slider-area">
        <div class="hero-slider-active slick-dot-style slider-arrow-style">
            <div class="single-slider d-flex align-items-center" style="background-image: url(../assets/img/slider/slider1-home1.jpg);">
                <div class="container-fluid">
                    <div class="row">
            ...
            <div class="single-slider d-flex align-items-center" style="background-image: url(../../assets/img/slider/slider2-home1.jpg);">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6 col-sm-8">
                            <div class="slider-text">
                        ...
                        <div class="product-gallary-active owl-carousel owl-arrow-style product-spacing">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="../../assets/img/product/product-11.jpg" class="pri-img" alt="">
                                        <img src="../../assets/img/product/product-13.jpg" class="sec-img" alt="">
                                    </a>
                                    <div class="box-label">
                                        <div class="label-product label_new">
                                            <span>new</span>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="single-banner-statics">
                        <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/banner/img1-top-sinrato1.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="single-banner-statics">
                        <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/banner/img2-top-sinrato1.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="single-banner-statics">
                        <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/banner/img3-top-sinrato1.jpg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="featured-cat-active owl-carousel owl-arrow-style">
                        <div class="pro-layout-two-single-item">
                            <div class="product-layout-two mb-30">
                                ...
                                <div class="product-layout-thumb">
                                    <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/product/pro-layout-img1.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="product-layout-two mb-30">
                                <div class="product-layout-info">
                        ...
                        <div class="pro-layout-two-single-item">
                            <div class="product-layout-two mb-30">
                                ...
                                <div class="product-layout-thumb">
                                    <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/product/pro-layout-img3.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="product-layout-two mb-30">
                                <div class="product-layout-info">
                                ...
                                <div class="product-layout-thumb">
                                    <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/product/pro-layout-img4.jpg" alt=""></a>
                                </div>
                            </div>
                        </div> <!-- </ end single item -->
                        <div class="pro-layout-two-single-item">
                            <div class="product-layout-two mb-30">
                                ...
                                <div class="product-layout-thumb">
                                    <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/product/pro-layout-img5.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="product-layout-two mb-30">
                                <div class="product-layout-info">
                                ...
                                <div class="product-layout-thumb">
                                    <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/product/pro-layout-img6.jpg" alt=""></a>
                                </div>
                            </div>
                        </div> <!-- </ end single item -->
                        <div class="pro-layout-two-single-item">
                            <div class="product-layout-two mb-30">
                                ...
                                <div class="product-layout-thumb">
                                    <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/product/pro-layout-img7.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="product-layout-two mb-30">
                                <div class="product-layout-info">
                                ...
                                <div class="product-layout-thumb">
                                    <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/product/pro-layout-img8.jpg" alt=""></a>
                                </div>
                            </div>
                        </div> <!-- </ end single item -->
                        <div class="pro-layout-two-single-item">
                            <div class="product-layout-two mb-30">
                                ...
                                <div class="product-layout-thumb">
                                    <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/product/pro-layout-img9.jpg" alt=""></a>
                                </div>
                            </div>
                            <div class="product-layout-two mb-30">
                                <div class="product-layout-info">
                                ...
                                <div class="product-layout-thumb">
                                    <a href="shop-grid-left-sidebar.html"><img src="../../assets/img/product/pro-layout-img10.jpg" alt=""></a>
                                </div>
                            </div>
                        </div> <!-- </ end single item -->
                    </div>
        ...
        <div class="container-fluid">
            <div class="section-title module-three">
                ...
                <div class="boxx-tab">
                    <ul class="nav my-tab" role="tablist">
                        <li role="presentation">
                            <button class="active" type="button" id="module-one-tab" data-toggle="tab" data-bs-target="#module-one" role="tab" aria-controls="module-one" aria-selected="true">Featured Products</button>
                        </li>
                        <li role="presentation">
                            <button data-bs-toggle="tab" type="button" id="module-two-tab" data-toggle="tab" data-bs-target="#module-two" role="tab" aria-controls="module-two" aria-selected="false">On sale Products</button>
                        </li>
                        <li role="presentation">
                            <button data-bs-toggle="tab" type="button" id="module-three-tab" data-toggle="tab" data-bs-target="#module-three" role="tab" aria-controls="module-three" aria-selected="false">Best sellers Products</button>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="module-four-wrapper custom-seven-column row">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a href="shop-grid-left-sidebar.html">
                                        <img src="/../../assets/img/product/img-module1.jpg" alt="" class="w-100">
                                    </a>
                                </div>
                            </div>
                        </div> <!-- single item end -->
                        ...
                        <div class="col mb-30">
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="../../assets/img/product/product-4.jpg" class="pri-img" alt="">
                                        <img src="../../assets/img/product/product-5.jpg" class="sec-img" alt="">
                                    </a>
                                    <div class="box-label">
                                        <div class="label-product label_new">
                                            <span>new</span>
                        ...
                        <div class="col mb-30">
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="../../assets/img/product/product-6.jpg" class="pri-img" alt="">
                                        <img src="../../assets/img/product/product-7.jpg" class="sec-img" alt="">
                                    </a>
                                    <div class="box-label">
                                        <div class="label-product label_new">
                                            <span>new</span>
                        ...
                        <div class="col mb-30">
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a href="product-details.html">
                                        <img src="../../assets/img/product/product-8.jpg" class="pri-img" alt="">
                                        <img src="../../assets/img/product/product-9.jpg" class="sec-img" alt="">
                                    </a>
                                    <div class="box-label">
                                        <div class="label-product label_new">
                    ...
                    <div class="module-four-wrapper custom-seven-column row">
                        <div class="col col-2 mb-30">
                                <div class="product-item">
                                    <div class="product-thumb">
                                        <a href="shop-grid-left-sidebar.html">
                                            <img src="../../assets/img/product/img-module1.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                        </div> <!-- single item end -->
